...
#ifndef DIVERTER_SYS_TYPES_H
#define DIVERTER_SYS_TYPES_H
#ifdef	__cplusplus
extern	"C"	{
#endif
...
/*
 * Enumerated Data Type:  Motor_Direction
 */
typedef enum {
 Diverter_Motor_Direction__UNINITIALIZED__e = -1,
 Diverter_Motor_Direction_Forward_e = 0,
 Diverter_Motor_Direction_Reverse_e = 1
} Diverter_Motor_Direction_t;

/*
 * Enumerated Data Type:  Machine_Side
 */
typedef enum {
 Diverter_Machine_Side__UNINITIALIZED__e = -1,
 Diverter_Machine_Side_Operator_e = 0,
 Diverter_Machine_Side_Drive_e = 1
} Diverter_Machine_Side_t;

/*
 * Enumerated Data Type:  Divert_Packet
 */
typedef enum {
 Diverter_Divert_Packet__UNINITIALIZED__e = -1,
 Diverter_Divert_Packet_Scrap_e = 0,
 Diverter_Divert_Packet_Inspection_e = 1
} Diverter_Divert_Packet_t;

/*
 * Enumerated Data Type:  Jog_Switch_Position
 */
typedef enum {
 Diverter_Jog_Switch_Position__UNINITIALIZED__e = -1,
 Diverter_Jog_Switch_Position_Stop_e = 0,
 Diverter_Jog_Switch_Position_Operator_e = 1,
 Diverter_Jog_Switch_Position_Drive_e = 2,
 Diverter_Jog_Switch_Position_Impossible_e = 3
...
#define Diverter_DOMAIN_ID 0
#define Diverter_DOMAIN_ID_text "Diverter"
