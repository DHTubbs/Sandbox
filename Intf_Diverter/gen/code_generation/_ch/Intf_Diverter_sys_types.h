/*----------------------------------------------------------------------------
 * File:  Intf_Diverter_sys_types.h
 *
...
#ifndef INTF_DIVERTER_SYS_TYPES_H
#define INTF_DIVERTER_SYS_TYPES_H
#ifdef	__cplusplus
extern	"C"	{
#endif
 ...
 */
typedef enum {
 Intf_Diverter_Divert_Packet__UNINITIALIZED__e = -1,
 Intf_Diverter_Divert_Packet_Scrap_e = 0,
 Intf_Diverter_Divert_Packet_Inspection_e = 1
} Intf_Diverter_Divert_Packet_t;

/*
 * Enumerated Data Type:  Jog_Switch_Position
 */
typedef enum {
 Intf_Diverter_Jog_Switch_Position__UNINITIALIZED__e = -1,
 Intf_Diverter_Jog_Switch_Position_Stop_e = 0,
 Intf_Diverter_Jog_Switch_Position_Operator_e = 1,
 Intf_Diverter_Jog_Switch_Position_Drive_e = 2,
 Intf_Diverter_Jog_Switch_Position_Impossible_e = 3
} Intf_Diverter_Jog_Switch_Position_t;
...
#endif
#endif  /* INTF_DIVERTER_SYS_TYPES_H */
